...
parser.add_argument('--save_path', help='directory for saving the networks of the experiment', type=str,default='../result/raindrop')
...
val_data_dir = '../data'
val_filename = 'test_a'
# val_data_dir = rf"/public/lay/transweather/data/real_rain+mist"
...
# validation_va1(net, val_data_loader, device_idx, save_path, save_tag=True)
